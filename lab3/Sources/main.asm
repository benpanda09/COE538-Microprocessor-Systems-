...
_Startup:
            ...
            JSR   cmd2LCD                    ;Sends command in Acc A to LCD
...
lb1         MOVB  #$90,ATDCTL5               ;r.just., unsign., sing.conv., mult., ch0, start conv.
            ...
            JSR   putcLCD
            LDAA  #'.'                       ;Output the . for the decimal point
...
msg1        dc.b  "Battery volt ",0          ;Display this message and follow by the battery voltage
msg2        dc.b  "Sw status ",0             ;Whether the switched it open/closed ---> ' ' / 'B/S'
...
;* This routine converts a 16 bit binary number in .D into BCD         *
