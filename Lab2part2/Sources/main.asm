...
;*******************************************************************
            ...
            ORG   $3000       ; Starts at $3000
            
firstHex    FCB   $83         ; Form constant byte at $83 for firstHex
secondHex   FCB   $39         ; Form constant byte at $39 for secondHex
            
mem1        RMB   01          ; mem1 is for the first number of firstHex
mem2        RMB   01          ; mem2 is for the second number of firstHex
mem3        RMB   01          ; mem3 is for the first number of secondHex
mem4        RMB   01          ; mem4 is for the second number of secondHex
mem5        RMB   01          ; Stores the terminating bit
...
MainLoop    JSR   clrLCD      ; clear LCD & home cursor
            ...
            STAA  mem5        ; store string termination char 00 into mem5 (mem5 is the terminating bit)  
            LDX   #0          
